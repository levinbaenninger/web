...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/3PNEvdgOKd)
...
```sh
npx nx serve travel-list
```

To create a production bundle:

```sh
npx nx build travel-list
```

To see all available targets to run for a project, run:

```sh
npx nx show project travel-list
```
