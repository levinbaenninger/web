...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/aQhMfiTghV)
...
```sh
npx nx serve eat-n-split
```

To create a production bundle:

```sh
npx nx build eat-n-split
```

To see all available targets to run for a project, run:

```sh
npx nx show project eat-n-split
```
